...
public class BlockIntersectionVisualizer extends JFrame {
    ...
    public BlockIntersectionVisualizer() {
        init();
        setTitle("Block Intersection Visualizer");
        setVisible(true);
        pack();
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(BlockIntersectionVisualizer::new);
    }
    ...
    private class DrawingPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            Block inter = blockA.intersection(blockB);
            if (inter != null) {
                inter.setColor(Color.red);
                inter.draw(g);
            }
