...
public class CritterModel {
    ...
    private Critter makeCritter(Class critter) throws Exception {
        ...
        } else if (parameters.length >0&&parameters[0] == Color.class){
            Color[] colors = new Color[]{Color.RED, Color.WHITE, Color.YELLOW, Color.BLACK};
            return (Critter) c.newInstance(new Object[]{colors[new Random().nextInt(4)]});
        }else {
    ...
    static class Info implements CritterInfo {
